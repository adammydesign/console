...
<span id="calendar-page" class="font">
    <div id="calendar-header" align="center">
        <?php if($dp && !$auto_hide){ ?>
        <div align="<?php echo($rtl ? "left" : "right"); ?>" class="closeme"><a href="javascript:closeMe();"><img src="../img/close.gif" border="0" alt="Close" title="Close" /></a></div>
        <?php } ?>
    ...
    <div id="calendar-container">
        ...
        <div id="calendar-footer">
            ...
            ?><a href="javascript:move('<?php echo(str_pad($previous_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($previous_year);?>');"><img src="../img/btn_<?php echo($rtl ? "next" : "previous"); ?>.gif" width="16" height="16" border="0" alt="Previous" title="Previous" /></a>
            <?php
            }else echo("&nbsp;");
            ?>
            </div>
            ...
            ?><a href="javascript:move('<?php echo(str_pad($next_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($next_year);?>');"><img src="../img/btn_<?php echo($rtl ? "previous" : "next"); ?>.gif" width="16" height="16" border="0" alt="Next" title="Next" /></a>
            <?php
            }else echo("&nbsp;");
            ?>
            </div>
