...
$type_query = mysql_query("SELECT * FROM `bodnant_c0nsole`.`event_type`");
...
<head>
    ...
    <title>Bodnant Welshfood | Create Event</title>
		...
		<div class="row-fluid">
			...
			<div class="span8">
				...
				<div class="well well-small">
					...
					<h3 class="thin pull-left">Create Event</h3>
					
					<!-- Event create Form -->
					<form action="create_valid.php" method="post">
					<button type="submit" class="btn btn-success pull-right"><i class="icon-ok icon-white"></i> Create Event</button>
					...
					<div class="well well-small">
							...
							<div class="span8">
								...
								<div class="row-fluid">
									...
									<div class="span10">
										...
										<strong><input type="text" name="name" placeholder="Event Name" class="span12" required></strong>
									</div>
								...
								<div class="row-fluid">
									...
									<div class="span6">
										...
										<input type="text" name="date" placeholder="Event Date" class="span12" id="datepicker" required>
									</div>
									
									<!-- Start Time -->
									<div class="span3">
										<label for="stime">Start Time:</label>
										<input type="text" name="stime" placeholder="Start Time" class="span12" id="stime" required>
									</div>
									
									<!-- End Time -->
									<div class="span3">
										<label for="etime">End Time:</label>
										<input type="text" name="etime" placeholder="End Time" class="span12" id="etime">
									</div>
								...
								<div class="row-fluid">
									...
									<div class="input-prepend input-append span6">
										...
										<input class="span8" id="appendedPrependedInput" placeholder="10.00" type="text" name="price" required>
									</div>
						...
						<!-- Upload Image Info -->
						<div class="well well-small">
							<small>Images should be no larger than 1MB in size and should be of relevance to the event. If there is no image selected then a default image will be assigned.</small>
						</div>
					</div>
					...
					<div class="well well-small well-white">
						...
						<div class="row-fluid">
							...
							<div class="span10">
								...
								<textarea placeholder="Event Description" name="desc" rows="5" class="span12"></textarea>
							...
							<div class="span2">
								...
								<input placeholder="00" type="number" name="capacity" class="span12" required>
							</div>
							<!-- Capacity end -->
			...
			<div class="span4">
				...
				<div class="well well-small">
					...
					while ($i < $row) {
						$type_ID = mysql_result($type_query, $i, "type_ID");
						$type_name = mysql_result($type_query, $i, "type_name");
						$type_location = mysql_result($type_query, $i, "type_location");
						
						$type_row = '<tr><td>'.$type_name.'</td><td>'.$type_location.'</td><td class="text-center"><input type="checkbox" name="event_type[]" value="'.$type_name.'"></td></tr>';					
						echo $type_row;
